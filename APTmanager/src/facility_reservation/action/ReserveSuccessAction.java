...
public class ReserveSuccessAction implements Action {
	...
	public ActionForward excute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		/*
		 * int f_id = (Integer) session.getAttribute("f_id"); int t_id =
		 * Integer.valueOf((String)session.getAttribute("t_id"));
		 */
		...
		/*
		 * System.out.println("f_id" + f_id); System.out.println("t_id"+t_id);
		 */
