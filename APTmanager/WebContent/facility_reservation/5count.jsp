...
$(function() {
	...
	$(function() {
		$("#reserve").click(function() {
			...
			location.href = "success.facility?fr_cnt=" + selected;
		});
	});
...
<body>
	...
	<div id="wrap">
				...
				<div class="inner">
					...
					<ul id="gnb" class="gnb">
						...
						<li class="menu4"><a href="/APTmanager/facility_reservation/1start.jsp">시설예약</a> 
							<ul class="gnb_list">
							<li><a href="/APTmanager/guest/facilityMain.jsp?body=facilityReview.jsp">시설후기작성</a></li>
								<li><a href="/APTmanager/guest/facilityMain.jsp?body=facilityRule.jsp">준수사항</a></li>
							</ul>
						</li>
						<li class="menu5">
		...
		<div id="container" class="story">
			...
			<form action="success.facility" method="post">
						<p>예약 가능 인원: ${spot}</p>
						<br> 
						<select name = "cnt">

							<c:forEach var="cnt" begin="1" end="${spot }">
								<option name = "fr_cnt" value="${cnt}" class="cnt">${cnt}</option>
							</c:forEach>

						</select> <br> <br> 
						
						<input type="submit" value="예약하기"	id="reserve">
