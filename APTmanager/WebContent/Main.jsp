	...
	<div id="wrap">
		...
		<div class="main_gnb">
			...
			<div id="header">
				<div class="inner">
					<h1>
						<a href="http://www.prugio.com/main.aspx">
							<img src="/APTmanager/css/images/common/logo.png" alt="PRUGIO">
						</a>
					</h1>
					<ul id="gnb" class="gnb">
						<li class="menu1">
						...
						<li class="menu2">
							<a href="http://www.prugio.com/construction/construction.aspx">관리비</a>
							<ul class="gnb_list">
						...
						<li class="menu5">
							...
							<ul class="gnb_list">
								<li><a href="http://www.prugio.com/product/premium-green.aspx">내 아파트 시세</a></li>
								<li><a href="http://www.prugio.com/product/merits-01.aspx">주변 아파트 시세</a></li>
							</ul>
						</li>
				...
				<div class="cont02">
					<div class="sale_box">
						...
						<ul class='sale_list item'>
							<li><a href='http://www.prugio.com/house/2017/dongtanlake/index.aspx' target='_blank'>
									<div class='thumb'>
										<img src='/PrugioBoard/Project/843/thumb (0).jpg' alt=''>
									</div>
	
										<dt>동탄 레이크 자연& 푸르지오</dt>
										<dd class="location">
											* 위치 : 동탄2신도시 택지개발지구 내 A86BL<br> * 총 704세대
										</dd>
										<dd class="tel">1599-5853</dd>
								 <span class="flag type1">예정</span>
							</a></li>
							
							<li><a	href='http://www.prugio.com/house/2017/gasancentral/index.aspx'	target='_blank'>
									<div class='thumb'>
										<img src='/PrugioBoard/Project/845/thumb.jpg' alt=''>
									</div>
									<dl>
										<dt>가산 센트럴 푸르지오 시티</dt>
										<dd class="location">
											* 위치 : 서울시 금천구 가산동 233-5<br> * 총 1,454실
										</dd>
										<dd class="tel">1877-9970</dd>
									</dl> <span class="flag type1">예정</span>
							</a></li>

							<li><a href='http://www.prugio.com/house/2017/uiwang_jangan2/index.aspx' target='_blank'>

									<div class='thumb'>
										<img src='/PrugioBoard/Project/827/thum_default.jpg' alt=''>
									</div>
									<dl>
										<dt>의왕 장안지구 파크 2차 푸르지오</dt>
										<dd class="location">
											* 위치 : 경기도 의왕시 삼동 74-2, 253<br> * 총 610세대
										</dd>
							...
							<li>
								<div class='thumb'>
									<img src='/PrugioBoard/Project/840/thum_default.jpg' alt=''>
								</div>
								<dl>
									<dt>과천 지식정보타운(가칭)</dt>
									<dd class="location">
										* 위치 : 경기도 과천시 지식정보타운<br> * 총 1,263세대 중 S4 679세대, S5
										584세대
									</dd>
							...
							<ul class='sale_list item'>
								<li>
									<div class='thumb'>
										<img src='/PrugioBoard/Project/819/thum_default (0).jpg' alt=''>
									</div>
									<dl>
										<dt>수원 영흥공원(가칭)</dt>
										<dd class="location">
											* 위치 : 경기도 수원시 영통구 영통동 2<br>* 총 1,999세대
										</dd>
										<dd class="tel">1670-1000</dd>
									</dl> <span class="flag type1">예정</span> </a>
								</li>

								<li>a
									<div class='thumb'>
										<img src='/PrugioBoard/Project/821/thum_default (0).jpg' alt=''>
									</div>
									<dl>
										<dt>창원 교방(가칭)</dt>
										<dd class="location">
											* 위치 : 창원시 마산합포구 교방동 75<br> * 총 1,538세대
										</dd>
										<dd class="tel">1670-1000</dd>
									</dl> <span class="flag type1">예정</span> </a>
								</li>
								<li>
									<div class='thumb'>
										<img src='/PrugioBoard/Project/837/thum_default.jpg' alt=''>
									</div>
									<dl>
										<dt>청주 새적굴공원(가칭)</dt>
										<dd class="location">
											* 위치 : 청주시 청원구 내덕동 산59-2<br> * 총 777세대
										</dd>
										<dd class="tel">1670-1000</dd>
									</dl> <span class="flag type1">예정</span> </a>
				...
				<div class="cont03">
					<div class="banner">
						<dl>
							...
							<dd>
								Life, Inspiration<br> 푸르지오의 다양한 모습을<br> 감상하세요.
							</dd>
					...
					<div class="banner">
						<dl>
							...
							<dd>
								프리미엄 라이프 스타일 매거진<br>푸르지오 웹진을 만나보세요.
							</dd>
