...
<link href="/APTmanager/
css/common/layout.css" rel="stylesheet">
	...
	<div id="wrap">
		...
		<div class="main_gnb">
			...
			<div id="header">
				<div class="inner">
					<h1>
						<a href="Main.bill"> <img
							src="/APTmanager/css/images/common/logo.png" alt="HILLSTATE">
						</a>
					</h1>
					<ul id="gnb" class="gnb">
						<li class="menu1"><a href="#">아파트소개</a>
							<ul class="gnb_list">
						...
						<li class="menu4"><a
							href="/APTmanager/facility_reservation/1start.jsp">시설예약</a>
							<ul class="gnb_list">
								<li><a
						...
						<li class="menu5"><a href="/APTmanager/RealEstate/start.jsp">부동산</a>
							<ul class="gnb_list">
					...
					<div id="util_id" class="util">
						<a id="login" href="#" onclick="login();">로그인</a> <a
							href="http://www.prugio.com/customer/faq.aspx">고객센터</a> <a
							href="http://www.prugio.com/myprugio/myprugio.aspx">마이푸르지오</a>
					</div>
				</div>
		...
		<div id="container" class="main">
			<div class="intro_cover">
				...
				<div class="cover_btn">
					<div class="inner">
						<a href="./sale/sale.aspx?menu=0" class="num01">신규분양 보기</a> <a
							href="./brand/pr-video.aspx" class="num02">홍보영상 보기</a> <a
							href="./cast/news.aspx" class="num03">이벤트 보기</a>
					</div>
				</div>
			</div>
			...
			<div class="contents">
				...
				<p id="allBill_title">${personBill.p_month }월청구서</p>
				<p class="allBill_content">
					요금 :
					<fmt:formatNumber value="${personBill.allBill()/17 }" pattern="0" />
					원
				</p>
				<p class="resident_content">삼성 힐스테이트 1단지 ${resident.r_dong } 동
					${resident.r_ho }호</p>
				<br>
	...
	<div id="footer">
		<div class="inner">
			...
			<span class="icsi_logo"> <img
				src="/APTmanager/css/images/common/logo_01.png" alt="" />
			</span> <span class="icsi_logo"> <img
				src="/APTmanager/css/images/common/logo_02.png" alt="" />
			</span>
			<div class="right_cont">
				<p class="customer_tel">고객센터 1670-1000</p>
				<a href="http://www.daewooenc.com/" target="_blank" class="dwlogo">
					<img src="/APTmanager/css/images/common/footer_logo_daewooenc.png"
					alt="(주)대우건설">
				</a>
			</div>
		</div>
